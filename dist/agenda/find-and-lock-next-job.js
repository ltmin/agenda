...
var debug = debug_1.default("agenda:internal:_findAndLockNextJob");
/**
 * Find and lock jobs
 ...
 */
var findAndLockNextJob = function (jobName, definition) {
    return __awaiter(this, void 0, void 0, function () {
        var now, lockDeadline, s, JOB_PROCESS_WHERE_QUERY, JOB_PROCESS_SET_QUERY, JOB_RETURN_QUERY, result, job;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    s = this._mdb.s || this._mdb.db.s;
                    if (!(s.topology.connections &&
                        s.topology.connections().length === 0 &&
                        !this._mongoUseUnifiedTopology)) return [3 /*break*/, 1];
                ...
                case 1:
                    ...
                    JOB_PROCESS_SET_QUERY = { $set: { lockedAt: now } };
                    JOB_RETURN_QUERY = { returnOriginal: false, sort: this._sort };
                    return [4 /*yield*/, this._collection.findOneAndUpdate(JOB_PROCESS_WHERE_QUERY, JOB_PROCESS_SET_QUERY, JOB_RETURN_QUERY)];
                case 2:
                    result = _a.sent();
                    job = undefined;
                    if (result.value) {
