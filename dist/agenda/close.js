...
var debug = debug_1.default("agenda:close");
...
var close = function (option) {
    return __awaiter(this, void 0, void 0, function () {
        var closeOptions, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    debug("close db connection for this agenda instance");
                    closeOptions = __assign({ force: false }, option);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    if (!this._db) return [3 /*break*/, 3];
                    return [4 /*yield*/, this._db.close(closeOptions.force)];
                case 2:
                    _a.sent();
                    _a.label = 3;
