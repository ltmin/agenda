 ...
 */
var jobs = function (query, sort, limit, skip) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, this._collection
                ...
                case 1:
                    result = _a.sent();
                    return [2 /*return*/, result.map(function (job) { return utils_1.createJob(_this, job); })];
            }
        });
    });
};
