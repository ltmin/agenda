 ...
 */
export declare const database: (this: Agenda, url: string, collection: string, options: MongoClientOptions, cb?: ((error: Error, collection: Collection<any> | null) => void) | undefined) => Agenda | void;
