            ...
            function runOrRetry() {
                if (self._processInterval) {
                    ...
                    if (jobDefinition.concurrency > jobDefinition.running &&
                        ...
                        if (!job_2.attrs.lockedAt || job_2.attrs.lockedAt < lockDeadline) {
                        ...
                        job_2
                            ...
                            .then(function (job) { return processJobResult(job); })
                            .catch(function (error) {
                            return job_2.agenda.emit("error", error);
                        });
                    }
                    else {
